...
class DomainAgent:
    ...
    async def maybe_collaborate(
        ...
        triggers = {
            ...
            "financial_planning": ("budget", "cash flow", "profitability", "capital plan"),
            "accounting": (
                "journal",
                "ledger",
                "balance sheet",
            ...
            "business": ("business plan", "startup", "feasibility", "business model"),
            "marketing": ("marketing", "campaign", "branding", "positioning", "segmentation"),
            "sales": ("sales forecast", "pipeline", "quota", "lead pipeline"),
            "operations": ("inventory", "procurement", "process optimization", "logistics"),
            "hr": ("hiring", "headcount", "org design", "onboarding"),
            "project_management": ("project plan", "milestone", "gantt", "raid"),
            "market_research": ("market research", "customer research", "tam"),
            "analytics": ("kpi", "dashboard", "trend analysis", "performance report"),
            "risk_compliance": ("compliance", "risk assessment", "regulatory"),
            "strategy": ("strategic direction", "corporate strategy", "competitive strategy"),
